function ODEfitPlot( figname, filename, ODEtimepoints, ODEData, meanTimepoints, meanData, stdData, SpeciesNames, legendpar)    
%     addpath(genpath(pwd));
    ...
    if ~isempty(filename)
        PDFprint(sprintf('%s_%s', filename, legendpar),  fig, 10, 10);
    end
end
