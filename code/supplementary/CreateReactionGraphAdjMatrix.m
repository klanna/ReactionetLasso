function [AdjMat, TPMat, FPMat, PMat, NodesProp] = CreateReactionGraphAdjMatrix( stoich, SpeciesNames, TPList, FPList, PriorList )
...
%        find reverse reaction
       ...
       AdjMat(indx_sp_out, sp_re) = 1;
       AdjMat(sp_re, indx_sp_in) = 1;
