function [AdjMat, TPMat, FPMat, PMat, NodesProp] = CreateReactionGraphAdjMatrixScoreSpecial( stoich, SpeciesNames, TPList, FPList, PriorList )
...
% PriorList
    ...
    ScoreList = 0.1*ones(size(stoich, 2), 1);
